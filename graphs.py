...
LpR_140 = [53.9, 53.4, 43.8, 54.4, 53.3, 68.2, 66.4, 67.6, 67.7, 67.3, 63.6, 60.5, 58.9, 60.4, 56.2, 55.8, 56.8, 56.6, 52.8, 49.1, 47.8] ## RECEPCIÓN
...
A1_LpR = [55.8, 54.5, 45.7, 57.0, 54.6, 68.3, 64.5, 66.6, 67.7, 66.0, 62.6, 60.0, 58.1, 62.0, 55.5, 55.2, 56.2, 55.8, 52.6, 49.4, 47.5]
...
DnT_140 = [21.0, 18.9, 28.7, 34.3, 36.2, 27.9, 35.2, 34.8, 35.7, 36.8, 40.1, 42.9, 44.5, 42.0, 45.6, 44.3, 44.3, 47.4, 49.5, 49.6, 49.7] # ISO 140-4
DnT_16283 = [17.0, 16.7, 28.4, 33.9, 35.6, 27.7, 35.2, 34.8, 35.7, 37.0, 40.1, 42.9, 44.5, 41.9, 45.5, 44.3, 44.2, 47.4, 49.5, 49.5, 49.7] # ISO 16283-1
DnT_BF = [24.8, 22.9, 26.8, 33.9, 35.6, 27.7, 35.2, 34.8, 35.7, 37.0, 40.1, 42.9, 44.5, 41.9, 45.5, 44.3, 44.2, 47.4, 49.5, 49.5, 49.7] # ISO 16283-1 | BF

##INDICE DE REDUCCION SONORA APARENTE
R_140 = [21.1, 19.0, 28.8, 34.5, 36.3, 28.1, 35.3, 35.0, 35.9, 37.0, 40.3, 43.1, 44.6, 42.2, 45.8, 44.5, 44.5, 47.5, 49.6, 49.8, 49.9] # ISO 140-4
R_16283 = [17.1, 16.8, 28.5, 34.1, 35.7, 27.9, 35.3, 35.0, 35.9, 37.2, 40.3, 43.1, 44.6, 42.1, 45.7, 44.5, 44.4, 47.5, 49.6, 49.7, 49.9] # ISO 16283-1
R_BF = [25.0, 23.0, 27.0,34.1, 35.7, 27.9, 35.3, 35.0, 35.9, 37.2, 40.3, 43.1, 44.6, 42.1, 45.7, 44.5, 44.4, 47.5, 49.6, 49.7, 49.9] # ISO 16283-1 | BF
